<x-app-layout>
    ...
    <div class="py-12">
        ...
        @endif
        <form action="" method="post" enctype="multipart/form-data" x-data="{imageName: null, imagePreview: null}">
            @csrf
                        ...
                        <div class="w-1/5">
                            <div class="bg-gray-100 p-5 rounded-md shadow-sm mb-3">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <a href="{{ route('category.create') }}" class="py-2 px-3 hover:text-amber-900 font-bold rounded-md hover:bg-yellow-400 hover:shadow-md duration-300 bg-gray-500 text-white text-center">Save draft</a>
                                    <a href="{{ route('category.create') }}" class="py-2 px-3 hover:text-amber-900 font-bold rounded-md hover:bg-yellow-400 hover:shadow-md duration-300 bg-gray-500 text-white text-center">Publish</a>
                                </div>
                            </div>
                                ...
                                <div class="mt-3">
                                    <div class="flex w-full items-center justify-center bg-grey-lighter">
                                        <label class="w-64 flex flex-col items-center py-3 bg-gray-500 text-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue hover:text-amber-900 hover:bg-yellow-400">
                                            ...
                                            <input id="image" type="file" class="hidden" name="image" accept="image/*" x-ref="image"
                                            x-on:change="
