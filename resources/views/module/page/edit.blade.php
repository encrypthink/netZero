        ...
        <form action="{{ route('pages.update', $page->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-7">
                    <div class="mb-7">
                        <h1 class="text-slate-900 font-extrabold text-4xl sm:text-xl lg:text-4xl">Edit Page</h1>
                    </div>
                        ...
                        <div class="w-4/5">
                            <div class="bg-gray-100 p-5 rounded-md shadow-sm">
                                <div class="col-span-6 sm:col-span-3 mb-4">
                                    ...
                                    <input type="text" name="title" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="{{ $page->title }}">
                                    @error('title')
                                    <p class="text-red-400 text-xs italic my-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                <x-forms.tinymce-editor value="{!! $page->body !!}"/>
                                @error('body')
