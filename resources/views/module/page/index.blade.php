        ...
        <div class="mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-7">
                <div class="grid grid-cols-2 mb-4">
                    <div class="mb-7">
                        <h1 class="text-slate-900 font-extrabold text-4xl sm:text-xl lg:text-4xl">Pages</h1>
                    </div>
                    <div>
                        <div class="flex justify-end">
                            <a href="{{ route('pages.create') }}" class="py-2 px-3 text-amber-900 font-bold rounded-md bg-yellow-400">Add New Pages</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="w-full whitespace-nowrap">
                        <thead class="font-bold border-b-2 border-yellow-400">
                            <tr>
                                ...
                                <td class="px-5 py-3">Page Url</td>
                        ...
                        <tbody>
                            ...
                            <tr tabindex="0" class="focus:outline-none h-16 border-gray-100 hover:bg-yellow-100">
                                ...
                                <td class="pl-4">
                                    <a href="{{ url('/page/' . $item->slug) }}">{{ url('/page/' . $item->slug) }}</a>
                                </td>
                                <td>
                                    <div class="flex">
